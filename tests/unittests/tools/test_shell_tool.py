...
class TestShellTool:
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_echo(self, tool_context_instance):
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_with_workdir(self, tmp_path, tool_context_instance):
    tool = shell_tool.ShellTool()
    if sys.platform == "win32":
      cmd = "cmd /c echo hello"
    else:
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_timeout(self, tool_context_instance):
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_nonzero_exit(self, tool_context_instance):
    tool = shell_tool.ShellTool()
    result = await tool.run_async(
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_stderr(self, tool_context_instance):
    tool = shell_tool.ShellTool()
    result = await tool.run_async(
        args={
            "command": (
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_python_script(self, tmp_path, tool_context_instance):
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_empty_command(self, tool_context_instance):
    tool = shell_tool.ShellTool()
    result = await tool.run_async(
        args={"command": ""},
        tool_context=tool_context_instance,
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_custom_timeout(self, tool_context_instance):
  ...
  @pytest.mark.asyncio
  async def test_shell_tool_policy_blocks_command(self, tool_context_instance):
